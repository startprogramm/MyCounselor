      ...
      <nav className="bg-white shadow">
        <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <div className="flex gap-4">
            <Link href="/student/dashboard" prefetch={false} className="text-slate-600 hover:text-slate-900">
              Dashboard
            </Link>
            <Link href="/student/requests" prefetch={false} className="text-slate-600 hover:text-slate-900">
              Requests
            </Link>
            <Link href="/student/messages" prefetch={false} className="text-slate-600 hover:text-slate-900">
              Messages
            </Link>
            <Link href="/student/meetings" prefetch={false} className="text-slate-600 hover:text-slate-900">
              Meetings
            </Link>
            <Link href="/student/guidance" prefetch={false} className="text-slate-600 hover:text-slate-900">
              Guidance
            </Link>
